...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../configuration.sopcinfo
...
# Design Name 
# setting SOPC_NAME is configuration
SOPC_NAME := configuration
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2001080
SOPC_SYSID_FLAG += --sidp=0x2001080
ELF_PATCH_FLAG  += --sidp 0x2001080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1636294757
SOPC_SYSID_FLAG += --timestamp=1636294757
ELF_PATCH_FLAG  += --timestamp 1636294757
