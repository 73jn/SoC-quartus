...
(
    ...
    localparam PAD7 = log2ceil(64'h2001078 - 64'h2001070); 
    localparam PAD8 = log2ceil(64'h2001080 - 64'h2001078); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h2001080;
    ...
    // ( 0x2001040 .. 0x2001050 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 26'h2001040  && write_transaction  ) begin
    ...
    // ( 0x2001070 .. 0x2001078 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 26'h2001070  && read_transaction  ) begin
            src_channel = 9'b000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x2001078 .. 0x2001080 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 26'h2001078   ) begin
