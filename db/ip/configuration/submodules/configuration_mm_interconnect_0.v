// configuration_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module configuration_mm_interconnect_0 (
		...
		input  wire        DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset,           //           DMA_LCD_0_reset_sink_reset_bridge_in_reset.reset
		...
		input  wire [31:0] DMA_LCD_0_avalon_master_address,                            //                              DMA_LCD_0_avalon_master.address
		output wire        DMA_LCD_0_avalon_master_waitrequest,                        //                                                     .waitrequest
		input  wire        DMA_LCD_0_avalon_master_read,                               //                                                     .read
		output wire [15:0] DMA_LCD_0_avalon_master_readdata,                           //                                                     .readdata
		...
		output wire [2:0]  DMA_LCD_0_avalon_address,                                   //                                     DMA_LCD_0_avalon.address
		output wire        DMA_LCD_0_avalon_write,                                     //                                                     .write
		output wire        DMA_LCD_0_avalon_read,                                      //                                                     .read
		input  wire [31:0] DMA_LCD_0_avalon_readdata,                                  //                                                     .readdata
		output wire [31:0] DMA_LCD_0_avalon_writedata,                                 //                                                     .writedata
		input  wire        DMA_LCD_0_avalon_waitrequest,                               //                                                     .waitrequest
		output wire        DMA_LCD_0_avalon_chipselect,                                //                                                     .chipselect
		output wire [2:0]  GPIO_parallel_port_0_avalon_slave_0_address,                //                  GPIO_parallel_port_0_avalon_slave_0.address
		output wire        GPIO_parallel_port_0_avalon_slave_0_write,                  //                                                     .write
		output wire        GPIO_parallel_port_0_avalon_slave_0_read,                   //                                                     .read
		input  wire [31:0] GPIO_parallel_port_0_avalon_slave_0_readdata,               //                                                     .readdata
		output wire [31:0] GPIO_parallel_port_0_avalon_slave_0_writedata,              //                                                     .writedata
		output wire        GPIO_parallel_port_0_avalon_slave_0_chipselect,             //                                                     .chipselect
	...
	wire          dma_lcd_0_avalon_master_translator_avalon_universal_master_0_waitrequest;          // DMA_LCD_0_avalon_master_agent:av_waitrequest -> DMA_LCD_0_avalon_master_translator:uav_waitrequest
	wire   [15:0] dma_lcd_0_avalon_master_translator_avalon_universal_master_0_readdata;             // DMA_LCD_0_avalon_master_agent:av_readdata -> DMA_LCD_0_avalon_master_translator:uav_readdata
	wire          dma_lcd_0_avalon_master_translator_avalon_universal_master_0_debugaccess;          // DMA_LCD_0_avalon_master_translator:uav_debugaccess -> DMA_LCD_0_avalon_master_agent:av_debugaccess
	wire   [31:0] dma_lcd_0_avalon_master_translator_avalon_universal_master_0_address;              // DMA_LCD_0_avalon_master_translator:uav_address -> DMA_LCD_0_avalon_master_agent:av_address
	wire          dma_lcd_0_avalon_master_translator_avalon_universal_master_0_read;                 // DMA_LCD_0_avalon_master_translator:uav_read -> DMA_LCD_0_avalon_master_agent:av_read
	wire    [1:0] dma_lcd_0_avalon_master_translator_avalon_universal_master_0_byteenable;           // DMA_LCD_0_avalon_master_translator:uav_byteenable -> DMA_LCD_0_avalon_master_agent:av_byteenable
	wire          dma_lcd_0_avalon_master_translator_avalon_universal_master_0_readdatavalid;        // DMA_LCD_0_avalon_master_agent:av_readdatavalid -> DMA_LCD_0_avalon_master_translator:uav_readdatavalid
	wire          dma_lcd_0_avalon_master_translator_avalon_universal_master_0_lock;                 // DMA_LCD_0_avalon_master_translator:uav_lock -> DMA_LCD_0_avalon_master_agent:av_lock
	wire          dma_lcd_0_avalon_master_translator_avalon_universal_master_0_write;                // DMA_LCD_0_avalon_master_translator:uav_write -> DMA_LCD_0_avalon_master_agent:av_write
	wire   [15:0] dma_lcd_0_avalon_master_translator_avalon_universal_master_0_writedata;            // DMA_LCD_0_avalon_master_translator:uav_writedata -> DMA_LCD_0_avalon_master_agent:av_writedata
	wire    [1:0] dma_lcd_0_avalon_master_translator_avalon_universal_master_0_burstcount;           // DMA_LCD_0_avalon_master_translator:uav_burstcount -> DMA_LCD_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                 // rsp_mux:src_valid -> DMA_LCD_0_avalon_master_agent:rp_valid
	wire   [91:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> DMA_LCD_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                 // DMA_LCD_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [8:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> DMA_LCD_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                         // rsp_mux:src_startofpacket -> DMA_LCD_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                           // rsp_mux:src_endofpacket -> DMA_LCD_0_avalon_master_agent:rp_endofpacket
	...
	wire   [31:0] dma_lcd_0_avalon_agent_m0_readdata;                                                // DMA_LCD_0_avalon_translator:uav_readdata -> DMA_LCD_0_avalon_agent:m0_readdata
	wire          dma_lcd_0_avalon_agent_m0_waitrequest;                                             // DMA_LCD_0_avalon_translator:uav_waitrequest -> DMA_LCD_0_avalon_agent:m0_waitrequest
	wire          dma_lcd_0_avalon_agent_m0_debugaccess;                                             // DMA_LCD_0_avalon_agent:m0_debugaccess -> DMA_LCD_0_avalon_translator:uav_debugaccess
	wire   [31:0] dma_lcd_0_avalon_agent_m0_address;                                                 // DMA_LCD_0_avalon_agent:m0_address -> DMA_LCD_0_avalon_translator:uav_address
	wire    [3:0] dma_lcd_0_avalon_agent_m0_byteenable;                                              // DMA_LCD_0_avalon_agent:m0_byteenable -> DMA_LCD_0_avalon_translator:uav_byteenable
	wire          dma_lcd_0_avalon_agent_m0_read;                                                    // DMA_LCD_0_avalon_agent:m0_read -> DMA_LCD_0_avalon_translator:uav_read
	wire          dma_lcd_0_avalon_agent_m0_readdatavalid;                                           // DMA_LCD_0_avalon_translator:uav_readdatavalid -> DMA_LCD_0_avalon_agent:m0_readdatavalid
	wire          dma_lcd_0_avalon_agent_m0_lock;                                                    // DMA_LCD_0_avalon_agent:m0_lock -> DMA_LCD_0_avalon_translator:uav_lock
	wire   [31:0] dma_lcd_0_avalon_agent_m0_writedata;                                               // DMA_LCD_0_avalon_agent:m0_writedata -> DMA_LCD_0_avalon_translator:uav_writedata
	wire          dma_lcd_0_avalon_agent_m0_write;                                                   // DMA_LCD_0_avalon_agent:m0_write -> DMA_LCD_0_avalon_translator:uav_write
	wire    [2:0] dma_lcd_0_avalon_agent_m0_burstcount;                                              // DMA_LCD_0_avalon_agent:m0_burstcount -> DMA_LCD_0_avalon_translator:uav_burstcount
	wire          dma_lcd_0_avalon_agent_rf_source_valid;                                            // DMA_LCD_0_avalon_agent:rf_source_valid -> DMA_LCD_0_avalon_agent_rsp_fifo:in_valid
	wire  [110:0] dma_lcd_0_avalon_agent_rf_source_data;                                             // DMA_LCD_0_avalon_agent:rf_source_data -> DMA_LCD_0_avalon_agent_rsp_fifo:in_data
	wire          dma_lcd_0_avalon_agent_rf_source_ready;                                            // DMA_LCD_0_avalon_agent_rsp_fifo:in_ready -> DMA_LCD_0_avalon_agent:rf_source_ready
	wire          dma_lcd_0_avalon_agent_rf_source_startofpacket;                                    // DMA_LCD_0_avalon_agent:rf_source_startofpacket -> DMA_LCD_0_avalon_agent_rsp_fifo:in_startofpacket
	wire          dma_lcd_0_avalon_agent_rf_source_endofpacket;                                      // DMA_LCD_0_avalon_agent:rf_source_endofpacket -> DMA_LCD_0_avalon_agent_rsp_fifo:in_endofpacket
	wire          dma_lcd_0_avalon_agent_rsp_fifo_out_valid;                                         // DMA_LCD_0_avalon_agent_rsp_fifo:out_valid -> DMA_LCD_0_avalon_agent:rf_sink_valid
	wire  [110:0] dma_lcd_0_avalon_agent_rsp_fifo_out_data;                                          // DMA_LCD_0_avalon_agent_rsp_fifo:out_data -> DMA_LCD_0_avalon_agent:rf_sink_data
	wire          dma_lcd_0_avalon_agent_rsp_fifo_out_ready;                                         // DMA_LCD_0_avalon_agent:rf_sink_ready -> DMA_LCD_0_avalon_agent_rsp_fifo:out_ready
	wire          dma_lcd_0_avalon_agent_rsp_fifo_out_startofpacket;                                 // DMA_LCD_0_avalon_agent_rsp_fifo:out_startofpacket -> DMA_LCD_0_avalon_agent:rf_sink_startofpacket
	wire          dma_lcd_0_avalon_agent_rsp_fifo_out_endofpacket;                                   // DMA_LCD_0_avalon_agent_rsp_fifo:out_endofpacket -> DMA_LCD_0_avalon_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                 // cmd_mux:src_valid -> DMA_LCD_0_avalon_agent:cp_valid
	wire  [109:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> DMA_LCD_0_avalon_agent:cp_data
	wire          cmd_mux_src_ready;                                                                 // DMA_LCD_0_avalon_agent:cp_ready -> cmd_mux:src_ready
	wire    [8:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> DMA_LCD_0_avalon_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                         // cmd_mux:src_startofpacket -> DMA_LCD_0_avalon_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                           // cmd_mux:src_endofpacket -> DMA_LCD_0_avalon_agent:cp_endofpacket
	...
	wire   [31:0] gpio_parallel_port_0_avalon_slave_0_agent_m0_readdata;                             // GPIO_parallel_port_0_avalon_slave_0_translator:uav_readdata -> GPIO_parallel_port_0_avalon_slave_0_agent:m0_readdata
	wire          gpio_parallel_port_0_avalon_slave_0_agent_m0_waitrequest;                          // GPIO_parallel_port_0_avalon_slave_0_translator:uav_waitrequest -> GPIO_parallel_port_0_avalon_slave_0_agent:m0_waitrequest
	wire          gpio_parallel_port_0_avalon_slave_0_agent_m0_debugaccess;                          // GPIO_parallel_port_0_avalon_slave_0_agent:m0_debugaccess -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_debugaccess
	wire   [31:0] gpio_parallel_port_0_avalon_slave_0_agent_m0_address;                              // GPIO_parallel_port_0_avalon_slave_0_agent:m0_address -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_address
	wire    [3:0] gpio_parallel_port_0_avalon_slave_0_agent_m0_byteenable;                           // GPIO_parallel_port_0_avalon_slave_0_agent:m0_byteenable -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_byteenable
	wire          gpio_parallel_port_0_avalon_slave_0_agent_m0_read;                                 // GPIO_parallel_port_0_avalon_slave_0_agent:m0_read -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_read
	wire          gpio_parallel_port_0_avalon_slave_0_agent_m0_readdatavalid;                        // GPIO_parallel_port_0_avalon_slave_0_translator:uav_readdatavalid -> GPIO_parallel_port_0_avalon_slave_0_agent:m0_readdatavalid
	wire          gpio_parallel_port_0_avalon_slave_0_agent_m0_lock;                                 // GPIO_parallel_port_0_avalon_slave_0_agent:m0_lock -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_lock
	wire   [31:0] gpio_parallel_port_0_avalon_slave_0_agent_m0_writedata;                            // GPIO_parallel_port_0_avalon_slave_0_agent:m0_writedata -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_writedata
	wire          gpio_parallel_port_0_avalon_slave_0_agent_m0_write;                                // GPIO_parallel_port_0_avalon_slave_0_agent:m0_write -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_write
	wire    [2:0] gpio_parallel_port_0_avalon_slave_0_agent_m0_burstcount;                           // GPIO_parallel_port_0_avalon_slave_0_agent:m0_burstcount -> GPIO_parallel_port_0_avalon_slave_0_translator:uav_burstcount
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rf_source_valid;                         // GPIO_parallel_port_0_avalon_slave_0_agent:rf_source_valid -> GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:in_valid
	wire  [110:0] gpio_parallel_port_0_avalon_slave_0_agent_rf_source_data;                          // GPIO_parallel_port_0_avalon_slave_0_agent:rf_source_data -> GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:in_data
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rf_source_ready;                         // GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:in_ready -> GPIO_parallel_port_0_avalon_slave_0_agent:rf_source_ready
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rf_source_startofpacket;                 // GPIO_parallel_port_0_avalon_slave_0_agent:rf_source_startofpacket -> GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:in_startofpacket
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rf_source_endofpacket;                   // GPIO_parallel_port_0_avalon_slave_0_agent:rf_source_endofpacket -> GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:in_endofpacket
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_valid;                      // GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:out_valid -> GPIO_parallel_port_0_avalon_slave_0_agent:rf_sink_valid
	wire  [110:0] gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_data;                       // GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:out_data -> GPIO_parallel_port_0_avalon_slave_0_agent:rf_sink_data
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_ready;                      // GPIO_parallel_port_0_avalon_slave_0_agent:rf_sink_ready -> GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:out_ready
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_startofpacket;              // GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:out_startofpacket -> GPIO_parallel_port_0_avalon_slave_0_agent:rf_sink_startofpacket
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_endofpacket;                // GPIO_parallel_port_0_avalon_slave_0_agent_rsp_fifo:out_endofpacket -> GPIO_parallel_port_0_avalon_slave_0_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                             // cmd_mux_002:src_valid -> GPIO_parallel_port_0_avalon_slave_0_agent:cp_valid
	wire  [109:0] cmd_mux_002_src_data;                                                              // cmd_mux_002:src_data -> GPIO_parallel_port_0_avalon_slave_0_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                             // GPIO_parallel_port_0_avalon_slave_0_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                           // cmd_mux_002:src_channel -> GPIO_parallel_port_0_avalon_slave_0_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                     // cmd_mux_002:src_startofpacket -> GPIO_parallel_port_0_avalon_slave_0_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                       // cmd_mux_002:src_endofpacket -> GPIO_parallel_port_0_avalon_slave_0_agent:cp_endofpacket
	...
	wire  [109:0] cmd_mux_003_src_data;                                                              // cmd_mux_003:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                             // sysid_qsys_0_control_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                           // cmd_mux_003:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                           // cmd_mux_007:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire          dma_lcd_0_avalon_master_agent_cp_valid;                                            // DMA_LCD_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire   [91:0] dma_lcd_0_avalon_master_agent_cp_data;                                             // DMA_LCD_0_avalon_master_agent:cp_data -> router:sink_data
	wire          dma_lcd_0_avalon_master_agent_cp_ready;                                            // router:sink_ready -> DMA_LCD_0_avalon_master_agent:cp_ready
	wire          dma_lcd_0_avalon_master_agent_cp_startofpacket;                                    // DMA_LCD_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dma_lcd_0_avalon_master_agent_cp_endofpacket;                                      // DMA_LCD_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          dma_lcd_0_avalon_agent_rp_valid;                                                   // DMA_LCD_0_avalon_agent:rp_valid -> router_003:sink_valid
	wire  [109:0] dma_lcd_0_avalon_agent_rp_data;                                                    // DMA_LCD_0_avalon_agent:rp_data -> router_003:sink_data
	wire          dma_lcd_0_avalon_agent_rp_ready;                                                   // router_003:sink_ready -> DMA_LCD_0_avalon_agent:rp_ready
	wire          dma_lcd_0_avalon_agent_rp_startofpacket;                                           // DMA_LCD_0_avalon_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          dma_lcd_0_avalon_agent_rp_endofpacket;                                             // DMA_LCD_0_avalon_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [109:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                         // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_004:sink_data
	...
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rp_valid;                                // GPIO_parallel_port_0_avalon_slave_0_agent:rp_valid -> router_005:sink_valid
	wire  [109:0] gpio_parallel_port_0_avalon_slave_0_agent_rp_data;                                 // GPIO_parallel_port_0_avalon_slave_0_agent:rp_data -> router_005:sink_data
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rp_ready;                                // router_005:sink_ready -> GPIO_parallel_port_0_avalon_slave_0_agent:rp_ready
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rp_startofpacket;                        // GPIO_parallel_port_0_avalon_slave_0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rp_endofpacket;                          // GPIO_parallel_port_0_avalon_slave_0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [109:0] sysid_qsys_0_control_slave_agent_rp_data;                                          // sysid_qsys_0_control_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [109:0] altpll_0_pll_slave_agent_rp_data;                                                  // altpll_0_pll_slave_agent:rp_data -> router_008:sink_data
	...
	wire   [91:0] sdram_controller_s1_agent_rp_data;                                                 // SDRAM_controller_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [109:0] leds_s1_agent_rp_data;                                                             // LEDs_s1_agent:rp_data -> router_010:sink_data
	...
	wire          cmd_mux_006_src_valid;                                                             // cmd_mux_006:src_valid -> SDRAM_controller_s1_burst_adapter:sink0_valid
	wire   [91:0] cmd_mux_006_src_data;                                                              // cmd_mux_006:src_data -> SDRAM_controller_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                             // SDRAM_controller_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                           // cmd_mux_006:src_channel -> SDRAM_controller_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                     // cmd_mux_006:src_startofpacket -> SDRAM_controller_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                       // cmd_mux_006:src_endofpacket -> SDRAM_controller_s1_burst_adapter:sink0_endofpacket
	...
	wire  [109:0] cmd_demux_002_src0_data;                                                           // cmd_demux_002:src0_data -> cmd_mux_004:sink1_data
	...
	wire  [109:0] rsp_demux_004_src1_data;                                                           // rsp_demux_004:src1_data -> rsp_mux_002:sink0_data
	...
	wire          cmd_demux_src0_valid;                                                              // cmd_demux:src0_valid -> DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:in_valid
	wire   [91:0] cmd_demux_src0_data;                                                               // cmd_demux:src0_data -> DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:in_data
	wire          cmd_demux_src0_ready;                                                              // DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:in_ready -> cmd_demux:src0_ready
	wire    [8:0] cmd_demux_src0_channel;                                                            // cmd_demux:src0_channel -> DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:in_channel
	wire          cmd_demux_src0_startofpacket;                                                      // cmd_demux:src0_startofpacket -> DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src0_endofpacket;                                                        // cmd_demux:src0_endofpacket -> DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:in_endofpacket
	wire          dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_valid;           // DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:out_valid -> cmd_mux:sink0_valid
	wire  [109:0] dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_data;            // DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:out_data -> cmd_mux:sink0_data
	wire          dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_ready;           // cmd_mux:sink0_ready -> DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:out_ready
	wire    [8:0] dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_channel;         // DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:out_channel -> cmd_mux:sink0_channel
	wire          dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_startofpacket;   // DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:out_startofpacket -> cmd_mux:sink0_startofpacket
	wire          dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_endofpacket;     // DMA_LCD_0_avalon_master_to_DMA_LCD_0_avalon_cmd_width_adapter:out_endofpacket -> cmd_mux:sink0_endofpacket
	wire          cmd_demux_001_src6_valid;                                                          // cmd_demux_001:src6_valid -> cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:in_valid
	wire  [109:0] cmd_demux_001_src6_data;                                                           // cmd_demux_001:src6_data -> cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:in_data
	wire          cmd_demux_001_src6_ready;                                                          // cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:in_ready -> cmd_demux_001:src6_ready
	wire    [8:0] cmd_demux_001_src6_channel;                                                        // cmd_demux_001:src6_channel -> cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_001_src6_startofpacket;                                                  // cmd_demux_001:src6_startofpacket -> cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_001_src6_endofpacket;                                                    // cmd_demux_001:src6_endofpacket -> cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:in_endofpacket
	wire          cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_valid;                // cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:out_valid -> cmd_mux_006:sink0_valid
	wire   [91:0] cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_data;                 // cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:out_data -> cmd_mux_006:sink0_data
	wire          cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_ready;                // cmd_mux_006:sink0_ready -> cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:out_ready
	wire    [8:0] cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_channel;              // cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:out_channel -> cmd_mux_006:sink0_channel
	wire          cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_startofpacket;        // cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_006:sink0_startofpacket
	wire          cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_endofpacket;          // cpu_data_master_to_SDRAM_controller_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_006:sink0_endofpacket
	wire          cmd_demux_002_src1_valid;                                                          // cmd_demux_002:src1_valid -> cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:in_valid
	wire  [109:0] cmd_demux_002_src1_data;                                                           // cmd_demux_002:src1_data -> cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src1_ready;                                                          // cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src1_ready
	wire    [8:0] cmd_demux_002_src1_channel;                                                        // cmd_demux_002:src1_channel -> cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src1_startofpacket;                                                  // cmd_demux_002:src1_startofpacket -> cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src1_endofpacket;                                                    // cmd_demux_002:src1_endofpacket -> cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:in_endofpacket
	wire          cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_valid;         // cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:out_valid -> cmd_mux_006:sink1_valid
	wire   [91:0] cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_data;          // cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:out_data -> cmd_mux_006:sink1_data
	wire          cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_ready;         // cmd_mux_006:sink1_ready -> cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:out_ready
	wire    [8:0] cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_channel;       // cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:out_channel -> cmd_mux_006:sink1_channel
	wire          cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_startofpacket; // cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_006:sink1_startofpacket
	wire          cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_endofpacket;   // cpu_instruction_master_to_SDRAM_controller_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_006:sink1_endofpacket
	wire          rsp_demux_src0_valid;                                                              // rsp_demux:src0_valid -> DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:in_valid
	wire  [109:0] rsp_demux_src0_data;                                                               // rsp_demux:src0_data -> DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:in_data
	wire          rsp_demux_src0_ready;                                                              // DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:in_ready -> rsp_demux:src0_ready
	wire    [8:0] rsp_demux_src0_channel;                                                            // rsp_demux:src0_channel -> DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:in_channel
	wire          rsp_demux_src0_startofpacket;                                                      // rsp_demux:src0_startofpacket -> DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src0_endofpacket;                                                        // rsp_demux:src0_endofpacket -> DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:in_endofpacket
	wire          dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_valid;           // DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:out_valid -> rsp_mux:sink0_valid
	wire   [91:0] dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_data;            // DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:out_data -> rsp_mux:sink0_data
	wire          dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_ready;           // rsp_mux:sink0_ready -> DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:out_ready
	wire    [8:0] dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_channel;         // DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:out_channel -> rsp_mux:sink0_channel
	wire          dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_startofpacket;   // DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:out_startofpacket -> rsp_mux:sink0_startofpacket
	wire          dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_endofpacket;     // DMA_LCD_0_avalon_to_DMA_LCD_0_avalon_master_rsp_width_adapter:out_endofpacket -> rsp_mux:sink0_endofpacket
	wire          rsp_demux_006_src0_valid;                                                          // rsp_demux_006:src0_valid -> SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:in_valid
	wire   [91:0] rsp_demux_006_src0_data;                                                           // rsp_demux_006:src0_data -> SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:in_data
	wire          rsp_demux_006_src0_ready;                                                          // SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:in_ready -> rsp_demux_006:src0_ready
	wire    [8:0] rsp_demux_006_src0_channel;                                                        // rsp_demux_006:src0_channel -> SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:in_channel
	wire          rsp_demux_006_src0_startofpacket;                                                  // rsp_demux_006:src0_startofpacket -> SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_006_src0_endofpacket;                                                    // rsp_demux_006:src0_endofpacket -> SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:in_endofpacket
	wire          sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_valid;                // SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:out_valid -> rsp_mux_001:sink6_valid
	wire  [109:0] sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_data;                 // SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:out_data -> rsp_mux_001:sink6_data
	wire          sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_ready;                // rsp_mux_001:sink6_ready -> SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:out_ready
	wire    [8:0] sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_channel;              // SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink6_channel
	wire          sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_startofpacket;        // SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:out_startofpacket -> rsp_mux_001:sink6_startofpacket
	wire          sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_endofpacket;          // SDRAM_controller_s1_to_cpu_data_master_rsp_width_adapter:out_endofpacket -> rsp_mux_001:sink6_endofpacket
	wire          rsp_demux_006_src1_valid;                                                          // rsp_demux_006:src1_valid -> SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:in_valid
	wire   [91:0] rsp_demux_006_src1_data;                                                           // rsp_demux_006:src1_data -> SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:in_data
	wire          rsp_demux_006_src1_ready;                                                          // SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:in_ready -> rsp_demux_006:src1_ready
	wire    [8:0] rsp_demux_006_src1_channel;                                                        // rsp_demux_006:src1_channel -> SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:in_channel
	wire          rsp_demux_006_src1_startofpacket;                                                  // rsp_demux_006:src1_startofpacket -> SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_006_src1_endofpacket;                                                    // rsp_demux_006:src1_endofpacket -> SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:in_endofpacket
	wire          sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_valid;         // SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink1_valid
	wire  [109:0] sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_data;          // SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:out_data -> rsp_mux_002:sink1_data
	wire          sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_ready;         // rsp_mux_002:sink1_ready -> SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:out_ready
	wire    [8:0] sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_channel;       // SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink1_channel
	wire          sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_startofpacket; // SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink1_startofpacket
	wire          sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_endofpacket;   // SDRAM_controller_s1_to_cpu_instruction_master_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink1_endofpacket
	wire          cmd_demux_001_src5_valid;                                                          // cmd_demux_001:src5_valid -> crosser:in_valid
	wire  [109:0] cmd_demux_001_src5_data;                                                           // cmd_demux_001:src5_data -> crosser:in_data
	wire          cmd_demux_001_src5_ready;                                                          // crosser:in_ready -> cmd_demux_001:src5_ready
	wire    [8:0] cmd_demux_001_src5_channel;                                                        // cmd_demux_001:src5_channel -> crosser:in_channel
	...
	wire  [109:0] crosser_001_out_data;                                                              // crosser_001:out_data -> rsp_mux_001:sink5_data
	wire          crosser_001_out_ready;                                                             // rsp_mux_001:sink5_ready -> crosser_001:out_ready
	wire    [8:0] crosser_001_out_channel;                                                           // crosser_001:out_channel -> rsp_mux_001:sink5_channel
	...
	wire          dma_lcd_0_avalon_agent_rdata_fifo_src_valid;                                       // DMA_LCD_0_avalon_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] dma_lcd_0_avalon_agent_rdata_fifo_src_data;                                        // DMA_LCD_0_avalon_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          dma_lcd_0_avalon_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter:in_0_ready -> DMA_LCD_0_avalon_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                     // avalon_st_adapter:out_0_valid -> DMA_LCD_0_avalon_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                      // avalon_st_adapter:out_0_data -> DMA_LCD_0_avalon_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                     // DMA_LCD_0_avalon_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                     // avalon_st_adapter:out_0_error -> DMA_LCD_0_avalon_agent:rdata_fifo_sink_error
	...
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_valid;                    // GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_data;                     // GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_ready;                    // avalon_st_adapter_002:in_0_ready -> GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                 // avalon_st_adapter_002:out_0_valid -> GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                  // avalon_st_adapter_002:out_0_data -> GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                 // GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                 // avalon_st_adapter_002:out_0_error -> GPIO_parallel_port_0_avalon_slave_0_agent:rdata_fifo_sink_error
	...
	wire          sdram_controller_s1_agent_rdata_fifo_out_valid;                                    // SDRAM_controller_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [17:0] sdram_controller_s1_agent_rdata_fifo_out_data;                                     // SDRAM_controller_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          sdram_controller_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_006:in_0_ready -> SDRAM_controller_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                 // avalon_st_adapter_006:out_0_valid -> SDRAM_controller_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_006_out_0_data;                                                  // avalon_st_adapter_006:out_0_data -> SDRAM_controller_s1_agent:rdata_fifo_sink_data
	...
	) dma_lcd_0_avalon_master_translator (
		.clk                    (altpll_0_c0_clk),                                                            //                       clk.clk
		.reset                  (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                           //                     reset.reset
		.uav_address            (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (DMA_LCD_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (DMA_LCD_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_read                (DMA_LCD_0_avalon_master_read),                                               //                          .read
		.av_readdata            (DMA_LCD_0_avalon_master_readdata),                                           //                          .readdata
	...
	) dma_lcd_0_avalon_translator (
		.clk                    (altpll_0_c0_clk),                                  //                      clk.clk
		.reset                  (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (dma_lcd_0_avalon_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (dma_lcd_0_avalon_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (dma_lcd_0_avalon_agent_m0_read),                   //                         .read
		.uav_write              (dma_lcd_0_avalon_agent_m0_write),                  //                         .write
		.uav_waitrequest        (dma_lcd_0_avalon_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (dma_lcd_0_avalon_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (dma_lcd_0_avalon_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (dma_lcd_0_avalon_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (dma_lcd_0_avalon_agent_m0_writedata),              //                         .writedata
		.uav_lock               (dma_lcd_0_avalon_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (dma_lcd_0_avalon_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (DMA_LCD_0_avalon_address),                         //      avalon_anti_slave_0.address
		.av_write               (DMA_LCD_0_avalon_write),                           //                         .write
		.av_read                (DMA_LCD_0_avalon_read),                            //                         .read
		.av_readdata            (DMA_LCD_0_avalon_readdata),                        //                         .readdata
		.av_writedata           (DMA_LCD_0_avalon_writedata),                       //                         .writedata
		.av_waitrequest         (DMA_LCD_0_avalon_waitrequest),                     //                         .waitrequest
		.av_chipselect          (DMA_LCD_0_avalon_chipselect),                      //                         .chipselect
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) gpio_parallel_port_0_avalon_slave_0_translator (
		.clk                    (altpll_0_c0_clk),                                            //                      clk.clk
		.reset                  (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),           //                    reset.reset
		.uav_address            (gpio_parallel_port_0_avalon_slave_0_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (gpio_parallel_port_0_avalon_slave_0_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (gpio_parallel_port_0_avalon_slave_0_agent_m0_read),          //                         .read
		.uav_write              (gpio_parallel_port_0_avalon_slave_0_agent_m0_write),         //                         .write
		.uav_waitrequest        (gpio_parallel_port_0_avalon_slave_0_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (gpio_parallel_port_0_avalon_slave_0_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (gpio_parallel_port_0_avalon_slave_0_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (gpio_parallel_port_0_avalon_slave_0_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (gpio_parallel_port_0_avalon_slave_0_agent_m0_writedata),     //                         .writedata
		.uav_lock               (gpio_parallel_port_0_avalon_slave_0_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (gpio_parallel_port_0_avalon_slave_0_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (GPIO_parallel_port_0_avalon_slave_0_address),                //      avalon_anti_slave_0.address
		.av_write               (GPIO_parallel_port_0_avalon_slave_0_write),                  //                         .write
		.av_read                (GPIO_parallel_port_0_avalon_slave_0_read),                   //                         .read
		.av_readdata            (GPIO_parallel_port_0_avalon_slave_0_readdata),               //                         .readdata
		.av_writedata           (GPIO_parallel_port_0_avalon_slave_0_writedata),              //                         .writedata
		.av_chipselect          (GPIO_parallel_port_0_avalon_slave_0_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                           //              (terminated)
		.av_beginbursttransfer  (),                                                           //              (terminated)
		.av_burstcount          (),                                                           //              (terminated)
		.av_byteenable          (),                                                           //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dma_lcd_0_avalon_master_agent (
		.clk                   (altpll_0_c0_clk),                                                            //       clk.clk
		.reset                 (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                           // clk_reset.reset
		.av_address            (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dma_lcd_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dma_lcd_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dma_lcd_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dma_lcd_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dma_lcd_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dma_lcd_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) dma_lcd_0_avalon_agent (
		.clk                     (altpll_0_c0_clk),                                   //             clk.clk
		.reset                   (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (dma_lcd_0_avalon_agent_m0_address),                 //              m0.address
		.m0_burstcount           (dma_lcd_0_avalon_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (dma_lcd_0_avalon_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (dma_lcd_0_avalon_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (dma_lcd_0_avalon_agent_m0_lock),                    //                .lock
		.m0_readdata             (dma_lcd_0_avalon_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (dma_lcd_0_avalon_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (dma_lcd_0_avalon_agent_m0_read),                    //                .read
		.m0_waitrequest          (dma_lcd_0_avalon_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (dma_lcd_0_avalon_agent_m0_writedata),               //                .writedata
		.m0_write                (dma_lcd_0_avalon_agent_m0_write),                   //                .write
		.rp_endofpacket          (dma_lcd_0_avalon_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (dma_lcd_0_avalon_agent_rp_ready),                   //                .ready
		.rp_valid                (dma_lcd_0_avalon_agent_rp_valid),                   //                .valid
		.rp_data                 (dma_lcd_0_avalon_agent_rp_data),                    //                .data
		.rp_startofpacket        (dma_lcd_0_avalon_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (dma_lcd_0_avalon_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (dma_lcd_0_avalon_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (dma_lcd_0_avalon_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (dma_lcd_0_avalon_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (dma_lcd_0_avalon_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (dma_lcd_0_avalon_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (dma_lcd_0_avalon_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (dma_lcd_0_avalon_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (dma_lcd_0_avalon_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (dma_lcd_0_avalon_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (dma_lcd_0_avalon_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dma_lcd_0_avalon_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (dma_lcd_0_avalon_agent_rdata_fifo_src_data),        //                .data
	...
	) dma_lcd_0_avalon_agent_rsp_fifo (
		.clk               (altpll_0_c0_clk),                                   //       clk.clk
		.reset             (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (dma_lcd_0_avalon_agent_rf_source_data),             //        in.data
		.in_valid          (dma_lcd_0_avalon_agent_rf_source_valid),            //          .valid
		.in_ready          (dma_lcd_0_avalon_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (dma_lcd_0_avalon_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (dma_lcd_0_avalon_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (dma_lcd_0_avalon_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (dma_lcd_0_avalon_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (dma_lcd_0_avalon_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (dma_lcd_0_avalon_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (dma_lcd_0_avalon_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) gpio_parallel_port_0_avalon_slave_0_agent (
		.clk                     (altpll_0_c0_clk),                                                      //             clk.clk
		.reset                   (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                     //       clk_reset.reset
		.m0_address              (gpio_parallel_port_0_avalon_slave_0_agent_m0_address),                 //              m0.address
		.m0_burstcount           (gpio_parallel_port_0_avalon_slave_0_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (gpio_parallel_port_0_avalon_slave_0_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (gpio_parallel_port_0_avalon_slave_0_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (gpio_parallel_port_0_avalon_slave_0_agent_m0_lock),                    //                .lock
		.m0_readdata             (gpio_parallel_port_0_avalon_slave_0_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (gpio_parallel_port_0_avalon_slave_0_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (gpio_parallel_port_0_avalon_slave_0_agent_m0_read),                    //                .read
		.m0_waitrequest          (gpio_parallel_port_0_avalon_slave_0_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (gpio_parallel_port_0_avalon_slave_0_agent_m0_writedata),               //                .writedata
		.m0_write                (gpio_parallel_port_0_avalon_slave_0_agent_m0_write),                   //                .write
		.rp_endofpacket          (gpio_parallel_port_0_avalon_slave_0_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (gpio_parallel_port_0_avalon_slave_0_agent_rp_ready),                   //                .ready
		.rp_valid                (gpio_parallel_port_0_avalon_slave_0_agent_rp_valid),                   //                .valid
		.rp_data                 (gpio_parallel_port_0_avalon_slave_0_agent_rp_data),                    //                .data
		.rp_startofpacket        (gpio_parallel_port_0_avalon_slave_0_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                                    //                .error
		.rdata_fifo_src_ready    (gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo (
		.clk               (altpll_0_c0_clk),                                                      //       clk.clk
		.reset             (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.in_data           (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_data),             //        in.data
		.in_valid          (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_valid),            //          .valid
		.in_ready          (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (gpio_parallel_port_0_avalon_slave_0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (gpio_parallel_port_0_avalon_slave_0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                                // (terminated)
		.csr_read          (1'b0),                                                                 // (terminated)
		.csr_write         (1'b0),                                                                 // (terminated)
		.csr_readdata      (),                                                                     // (terminated)
	...
	configuration_mm_interconnect_0_router router (
		.sink_ready         (dma_lcd_0_avalon_master_agent_cp_ready),           //      sink.ready
		.sink_valid         (dma_lcd_0_avalon_master_agent_cp_valid),           //          .valid
		.sink_data          (dma_lcd_0_avalon_master_agent_cp_data),            //          .data
		.sink_startofpacket (dma_lcd_0_avalon_master_agent_cp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (dma_lcd_0_avalon_master_agent_cp_endofpacket),     //          .endofpacket
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_router_001 router_001 (
	...
	configuration_mm_interconnect_0_router_002 router_002 (
	...
	configuration_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (dma_lcd_0_avalon_agent_rp_ready),                  //      sink.ready
		.sink_valid         (dma_lcd_0_avalon_agent_rp_valid),                  //          .valid
		.sink_data          (dma_lcd_0_avalon_agent_rp_data),                   //          .data
		.sink_startofpacket (dma_lcd_0_avalon_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (dma_lcd_0_avalon_agent_rp_endofpacket),            //          .endofpacket
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_router_004 router_004 (
	...
	configuration_mm_interconnect_0_router_004 router_005 (
		.sink_ready         (gpio_parallel_port_0_avalon_slave_0_agent_rp_ready),         //      sink.ready
		.sink_valid         (gpio_parallel_port_0_avalon_slave_0_agent_rp_valid),         //          .valid
		.sink_data          (gpio_parallel_port_0_avalon_slave_0_agent_rp_data),          //          .data
		.sink_startofpacket (gpio_parallel_port_0_avalon_slave_0_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (gpio_parallel_port_0_avalon_slave_0_agent_rp_endofpacket),   //          .endofpacket
		.clk                (altpll_0_c0_clk),                                            //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	configuration_mm_interconnect_0_router_004 router_006 (
	...
	configuration_mm_interconnect_0_router_007 router_007 (
	...
	configuration_mm_interconnect_0_router_004 router_008 (
	...
	configuration_mm_interconnect_0_router_009 router_009 (
	...
	configuration_mm_interconnect_0_router_004 router_010 (
	...
	configuration_mm_interconnect_0_router_004 router_011 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),        // cr0_reset.reset
	...
	configuration_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (altpll_0_c0_clk),                                  //        clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (altpll_0_c0_clk),                                      //        clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),     //  clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (altpll_0_c0_clk),                                                                 //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                // clk_reset.reset
		...
		.sink0_ready         (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_valid),         //          .valid
		.sink0_channel       (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_channel),       //          .channel
		.sink0_data          (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_data),          //          .data
		.sink0_startofpacket (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_endofpacket),   //          .endofpacket
	...
	configuration_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (altpll_0_c0_clk),                                  //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (altpll_0_c0_clk),                                  //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (altpll_0_c0_clk),                                  //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (altpll_0_c0_clk),                                  //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                              //       clk.clk
		.reset               (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux_006 cmd_mux_006 (
		.clk                 (altpll_0_c0_clk),                                                                   //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.sink0_ready         (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_ready),                //     sink0.ready
		.sink0_valid         (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_valid),                //          .valid
		.sink0_channel       (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_channel),              //          .channel
		.sink0_data          (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_data),                 //          .data
		.sink0_startofpacket (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_startofpacket),        //          .startofpacket
		.sink0_endofpacket   (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_endofpacket),          //          .endofpacket
		.sink1_ready         (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_ready),         //     sink1.ready
		.sink1_valid         (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink1_channel       (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink1_data          (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_data),          //          .data
		.sink1_startofpacket (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink1_endofpacket   (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_endofpacket)    //          .endofpacket
	);

	configuration_mm_interconnect_0_cmd_mux_001 cmd_mux_007 (
		.clk                 (altpll_0_c0_clk),                                  //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_cmd_mux_001 cmd_mux_008 (
		.clk                 (altpll_0_c0_clk),                                  //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_006 rsp_demux_006 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (altpll_0_c0_clk),                                  //       clk.clk
		.reset              (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	configuration_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (altpll_0_c0_clk),                                                                 //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                // clk_reset.reset
		...
		.sink0_ready         (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_valid),         //          .valid
		.sink0_channel       (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_channel),       //          .channel
		.sink0_data          (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_data),          //          .data
		.sink0_startofpacket (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);

	configuration_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (altpll_0_c0_clk),                                                            //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                           // clk_reset.reset
		...
		.sink6_ready         (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_ready),         //     sink6.ready
		.sink6_valid         (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_valid),         //          .valid
		.sink6_channel       (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_channel),       //          .channel
		.sink6_data          (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_data),          //          .data
		.sink6_startofpacket (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink6_endofpacket   (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_endofpacket),   //          .endofpacket
	...
	configuration_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (altpll_0_c0_clk),                                                                   //       clk.clk
		.reset               (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.sink1_ready         (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_ready),         //     sink1.ready
		.sink1_valid         (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_valid),         //          .valid
		.sink1_channel       (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_channel),       //          .channel
		.sink1_data          (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_data),          //          .data
		.sink1_startofpacket (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink1_endofpacket   (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	altera_merlin_width_adapter #(
	...
	) dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter (
		.clk                  (altpll_0_c0_clk),                                                                 //       clk.clk
		.reset                (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                // clk_reset.reset
		...
		.out_endofpacket      (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_data),          //          .data
		.out_channel          (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (dma_lcd_0_avalon_master_to_dma_lcd_0_avalon_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) cpu_data_master_to_sdram_controller_s1_cmd_width_adapter (
		.clk                  (altpll_0_c0_clk),                                                            //       clk.clk
		.reset                (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                           // clk_reset.reset
		...
		.out_endofpacket      (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (cpu_data_master_to_sdram_controller_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                      // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter (
		.clk                  (altpll_0_c0_clk),                                                                   //       clk.clk
		.reset                (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.out_endofpacket      (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (cpu_instruction_master_to_sdram_controller_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                             // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter (
		.clk                  (altpll_0_c0_clk),                                                                 //       clk.clk
		.reset                (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                // clk_reset.reset
		...
		.out_endofpacket      (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (dma_lcd_0_avalon_to_dma_lcd_0_avalon_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sdram_controller_s1_to_cpu_data_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                      // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter (
		.clk                  (altpll_0_c0_clk),                                                                   //       clk.clk
		.reset                (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		...
		.out_endofpacket      (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sdram_controller_s1_to_cpu_instruction_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                             // (terminated)
	);
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),           //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),           // out_clk_reset.reset
	...
	configuration_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dma_lcd_0_avalon_agent_rdata_fifo_src_data),       //     in_0.data
		.in_0_valid     (dma_lcd_0_avalon_agent_rdata_fifo_src_valid),      //         .valid
		.in_0_ready     (dma_lcd_0_avalon_agent_rdata_fifo_src_ready),      //         .ready
	...
	configuration_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (altpll_0_c0_clk),                                                // in_clk_0.clk
		.in_rst_0_reset (DMA_LCD_0_reset_sink_reset_bridge_in_reset_reset),               // in_rst_0.reset
		.in_0_data      (gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (gpio_parallel_port_0_avalon_slave_0_agent_rdata_fifo_src_ready), //         .ready
	...
	configuration_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
